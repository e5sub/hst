...
echo -e "\n"
sleep 5s
wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/1.7.5.1/set_extra_ip.sh
wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/1.7.5.1/set_protocol_addr.sh
wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/1.7.5.1/set_store_proxy.sh
wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/1.7.5.1/set_wb_app_id.sh
wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/1.7.5.1/add_protocol_addr.sh
wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/1.7.5.1/fsmeeting.conf
...
echo -e "\n"
sleep 5s
wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/1.8.3.5/set_extra_ip.sh
wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/1.8.3.5/set_protocol_addr.sh
wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/1.8.3.5/set_store_proxy.sh
wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/1.8.3.5/set_wb_app_id.sh
wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/1.8.3.5/add_protocol_addr.sh
wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/1.8.3.5/fsmeeting.conf
...
then
	...
	mkdir -p /home/frp
	cd /home/frp
	wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/frp/frps.ini
...
then
	...
	mkdir -p /home/frp
	cd /home/frp
	wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/frp/frpc.ini
...
then
	...
	sleep 5s	
	cd /usr/local/hst
    wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/4.36/nginx.tar.gz	
...
then
    ...
    wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/4.36/proxy.tar.gz
    tar -zxvf proxy.tar.gz -C /usr/local/nginx
    wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/4.36/ssl.tar.gz
...
then
	...
	echo -e "\n"
	sleep 5s	
	wget -N --no-check-certificate https://mirror.ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/resetadmin.sql
