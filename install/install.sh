...
then
	...
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate https://yaohst.com/Aliyun/好视通/02好视通视频会议企业版服务器/linux服务端/标准版/ces_linux_hst4.35.2.21.tar.gz -O ces_linux_hst4.35.2.21.tar.gz
	tar zxvf ces_linux_hst4.35.2.21.tar.gz
	cd ./ces_linux4.35.2.21
	bash server_install.sh cluster main	
fi
...
if [ $1 = '-gc435dj' ]
then
	echo -e "\033[33m 【你选择的是只安装国产化CES v4.35.1.29单机版服务器】 \033[0m"
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate https://yaohst.com/Aliyun/好视通/02好视通视频会议企业版服务器/linux服务端/ARM/标准版/ces_linux_arm4.35.1.29.tar.gz -O ces_linux_arm4.35.1.29.tar.gz
	tar zxvf ces_linux_arm4.35.1.29.tar.gz
	cd ./ces_linux4.35.1.29
	bash server_install.sh single
fi
if [ $1 = '-gc435jq' ]
then
	echo -e "\033[33m 【你选择的是只安装国产化CES v4.35.1.29集群主服务器】 \033[0m"
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate https://yaohst.com/Aliyun/好视通/02好视通视频会议企业版服务器/linux服务端/ARM/标准版/ces_linux_arm4.35.1.29.tar.gz -O ces_linux_arm4.35.1.29.tar.gz
	tar zxvf ces_linux_arm4.35.1.29.tar.gz
...
if [ $1 = '-gc435node' ]
then
	echo -e "\033[33m 【你选择的是只安装国产化CES v4.35.1.29集群节点服务器】 \033[0m"
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate https://yaohst.com/Aliyun/好视通/02好视通视频会议企业版服务器/linux服务端/ARM/标准版/ces_linux_arm4.35.1.29.tar.gz -O ces_linux_arm4.35.1.29.tar.gz
	tar zxvf ces_linux_arm4.35.1.29.tar.gz
...
if [ $1 = '-gc435face' ]
then
	echo -e "\033[33m 【你选择的是只安装国产化CES v4.35.1.29人脸识别服务器】 \033[0m"
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate https://yaohst.com/Aliyun/好视通/02好视通视频会议企业版服务器/linux服务端/ARM/标准版/ces_linux_arm4.35.1.29.tar.gz -O ces_linux_arm4.35.1.29.tar.gz
	tar zxvf ces_linux_arm4.35.1.29.tar.gz
...
then
	...
	echo -e "\n"
	sleep 5s
	wget --no-check-certificate https://yaohst.com/Aliyun/好视通/02好视通视频会议企业版服务器/linux服务端/ARM/中性版/ces_linux_arm_zx4.35.1.29.tar.gz -O ces_linux_arm_zx4.35.1.29.tar.gz
	tar zxvf ces_linux_arm_zx4.35.1.29.tar.gz
	cd ./ces_linux4.35.1.29
	bash server_install.sh single
fi
if [ $1 = '-gczx435jq' ]
