...
## China_IP
    ...
    if [[ -z "${CN}" ]]; then
        #CES标准版安装包下载地址
        CES436="wget --no-check-certificate https://yaohst.com/OS/好视通linux服务器安装包/标准版/ces_linux_hst4.36.5.4.tar.gz -O ces_linux_hst4.36.5.4.tar.gz"
        ...
        #CES中性版安装包下载地址
        ZXCES436="wget --no-check-certificate https://yaohst.com/OS/好视通linux服务器安装包/中性版/ces_linux_zx4.36.5.4.tar.gz -O ces_linux_zx4.36.5.4.tar.gz"
        ...
        #CES标准版安装包下载地址
        CES436="wget --no-check-certificate https://yaohst.com/Aliyun/好视通/02好视通视频会议企业版服务器/linux服务端/标准版/ces_linux_hst4.36.5.4.tar.gz -O ces_linux_hst4.36.5.4.tar.gz"
        ...
        #CES中性版安装包下载地址
        ZXCES436="wget --no-check-certificate https://yaohst.com/Aliyun/好视通/02好视通视频会议企业版服务器/linux服务端/中性版/ces_linux_zx4.36.5.4.tar.gz -O ces_linux_zx4.36.5.4.tar.gz"
