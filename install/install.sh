...
then
	...
	echo -e "\n"
	sleep 5s	
	wget --no-check-certificate https://yaohst.com/Aliyun/好视通/02好视通视频会议企业版服务器/H323网关MCU/h323gw_xd_pkg_2.3.1.12_%23292.tar.gz -O h323gw_xd_pkg_2.3.1.12_#292.tar.gz
