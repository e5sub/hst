...
echo -e " \033[32m 7. \033[0m CES v4.32.8.5服务器"
echo -e " \033[32m 8. \033[0m CES v4.32.8.5集群节点服务器"
echo -e " \033[31m=====*4.31版本*=====\033[0m"
echo -e " \033[32m 9. \033[0m CES v4.31.3.6服务器"
echo -e " \033[32m 10. \033[0m CES v4.31.3.6集群节点服务器"
echo -e " \033[44;37m 国产化CES服务端 For ARM \033[0m"
echo -e " \033[32m 20. \033[0m 国产化CES v4.35.1.30服务器"
echo -e " \033[32m 21. \033[0m 国产化CES v4.35.1.30节点服务器"
echo -e " \033[32m 22. \033[0m 国产化CES v4.34.5.1服务器"
echo -e " \033[32m 23. \033[0m 国产化CES v4.34.5.1节点服务器"
echo -e " \033[44;37m 国产化CES服务端 For MIPS \033[0m"
echo -e " \033[32m 30. \033[0m 国产化CES v4.35.1.30服务器"
echo -e " \033[32m 31. \033[0m 国产化CES v4.35.1.30节点服务器"
echo -e ""
...
case $N in
  ...
  2) bash install.sh -zx436node ;;
  3) bash install.sh -zx435 ;;
  4) bash install.sh -zx435node ;;
  5) bash install.sh -zx434 ;;
  6) bash install.sh -zx434node ;;
  7) bash install.sh -zx432 ;;
  8) bash install.sh -zx432node ;;
  9) bash install.sh -zx431 ;;
  10) bash install.sh -zx431node ;;
  20) bash install.sh -gczx435 ;;
  21) bash install.sh -gczx435node ;;
  22) bash install.sh -gczx434 ;;
  23) bash install.sh -gczx434node ;;
  30) bash install.sh -mzx435 ;;
  31) bash install.sh -mzx435node ;;
