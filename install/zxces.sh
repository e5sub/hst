...
echo -e " \033[32m 2. \033[0m CES v4.36.5.5服务器"
...
echo -e " \033[32m 5. \033[0m CES v4.32.8.5服务器"
echo -e " \033[31m=====*4.31版本*=====\033[0m"
echo -e " \033[32m 6. \033[0m CES v4.31.3.6服务器"
...
echo ""
case $N in
  1) bash cesinstall.sh -zx437 ;;
  2) bash cesinstall.sh -zx436 ;;
  3) bash cesinstall.sh -zx435 ;;
  4) bash cesinstall.sh -zx434 ;;
  5) bash cesinstall.sh -zx432 ;;
  6) bash cesinstall.sh -zx431 ;;
