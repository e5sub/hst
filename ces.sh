...
echo -e " \033[32m 85. \033[0m 安装Frp内网穿透客户端（配置文件存放路径/frp/frpc.ini）"
echo -e " \033[32m 85. \033[0m 安装Linux面板（需要服务器能连接公网）"
...
case $N in
  ...
  85) curl http://bt.1040155.xyz/install/install_6.0.sh|bash ;;
