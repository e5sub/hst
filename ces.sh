...
case $N in
  ...
  11) docker run -dit --restart=always -p 2022:2022 -p 1935:1935/tcp -p 1985:1985/tcp -p 8080:8080/tcp -p 8000:8000/udp -p 10080:10080/udp --name srs-cloud -v /home/ossrs/db:/data ossrs/srs-cloud:platform-1
  ...
  14) docker run -dit --name ddns-go --restart=always --net=host -v /opt/ddns-go:/root jeessy/ddns-go ;;
  ...
  21) docker run -dit -v /home/emby/movies:/data/movies -v /home/emby/config:/config -p 8096:8096 -p 8920:8920 --name=emby --restart=always xinjiawei1/emby_unlockd:latest ;;
  ...
  98) wget -N --no-check-certificate https://ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/old.sh && bash old.sh ;;
