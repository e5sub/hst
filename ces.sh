...
echo -e " \033[32m 26. \033[0m 安装homeassistant（8123端口）"
echo -e " \033[32m 27. \033[0m 设置每天凌晨两点自动更新容器镜像"
echo -e ""
...
case $N in
  ...
  16) docker run --name hbbs --net=host -v /home/rustdesk:/root -dit --restart=always rustdesk/rustdesk-server hbbs -r ${LOCAL_IP} -k 123456
      docker run --name hbbr --net=host -v /home/rustdesk:/root -dit --restart=always rustdesk/rustdesk-server hbbr -k 123456 ;;
