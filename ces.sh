...
echo -e " \033[32m 97. \033[0m 一键部署部署Prometheus+Grafana+node-exporter+consul"
echo -e ""
...
case $N in
  ...
  97) wget -N --no-check-certificate https://ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/grafana/install.sh && bash install.sh ;;
