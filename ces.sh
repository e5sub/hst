...
case $N in
  ...
  16) docker run --name hbbs -p 21115:21115 -p 21116:21116 -p 21116:21116/udp -p 21118:21118 -v /home/rustdesk:/root -dit --restart=always rustdesk/rustdesk-server hbbs -r ${LOCAL_IP} -k vM2D+zEEC6MdbvO3uNYhWrJGEJGlUTOeEeQ50X6PFY0=
      docker run --name hbbr -p 21117:21117 -p 21119:21119 -v /home/rustdesk:/root -dit --restart=always rustdesk/rustdesk-server hbbr -k vM2D+zEEC6MdbvO3uNYhWrJGEJGlUTOeEeQ50X6PFY0= ;;
