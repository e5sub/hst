...
echo -e " \033[32m 85. \033[0m 安装RustDesk远程桌面服务器（21115/21116/21117/21118/21119端口）"
echo -e " \033[32m 86. \033[0m 安装Frp内网穿透服务器（配置文件存放路径/frp/frps.ini）"
echo -e " \033[32m 87. \033[0m 安装Frp内网穿透客户端（配置文件存放路径/frp/frpc.ini）"
echo -e " \033[32m 88. \033[0m 安装Prometheus+Grafana+node-exporter+consul"
echo -e " \033[32m 880. \033[0m 安装node-exporter"
echo -e ""
echo -e " \033[32m 89. \033[0m 卸载CES服务器"
echo -e " \033[32m 90. \033[0m 卸载FSP服务器"
echo -e ""
echo -e " \033[32m 91. \033[0m 修改H323服务器配置信息（适用于2.4.2.2私有云版本）"
echo -e " \033[32m 92. \033[0m 修改H323服务器配置信息（适用于2.4.2.2云会议版本）"
echo -e " \033[32m 93. \033[0m 修改CES V4.36 配置信息（需先安装FSP服务器）"
echo -e " \033[32m 94. \033[0m 修改节点服务器配置信息（主服务器勿用）"
echo -e " \033[32m 95. \033[0m Nginx转发8443端口，隐藏公网8443后台页面（转发端口号18443）"
echo -e " \033[32m 96. \033[0m Nginx反代1089/8443/20020端口（需手动修改/usr/local/nginx/nginx.conf里的地址）"
echo -e " \033[32m 97. \033[0m 放行服务器所有端口"
echo -e ""
...
case $N in
  ...
  88) wget -N --no-check-certificate https://ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/grafana/install.sh && bash install.sh ;;
  880) wget -N --no-check-certificate https://ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/grafana/node.sh && bash node.sh ;;
  89) bash install.sh -xiezai ;;
  90) bash install.sh -unfsp ;;
  91) wget -N --no-check-certificate https://ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/h323pri.sh && bash h323pri.sh ;;
  92) wget -N --no-check-certificate https://ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/h323pub.sh && bash h323pub.sh ;;
  ...
  94) wget -N --no-check-certificate https://ghproxy.com/https://raw.githubusercontent.com/e5sub/hst/master/install/node.sh && bash node.sh ;;
  95) bash install.sh -nginx ;;
  96) bash install.sh -proxy ;;
  97) systemctl stop firewalld.service
