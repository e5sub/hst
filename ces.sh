...
echo "# * 脚本作者：Sugar                                                    "#
echo "#                                                                      "#
echo "# * 脚本更新时间：2022年5月27日，如有遇到安装问题请及时反馈            "#
echo "#                                                                      "#
...
echo -e " \033[32m 16. \033[0m CES v4.36.5.4单机版"
echo -e " \033[32m 17. \033[0m CES v4.36.5.4集群主服务器"
echo -e " \033[32m 18. \033[0m CES v4.36.5.4集群节点服务器"
#echo -e " \033[32m 19. \033[0m CES v4.36.5.4人脸识别服务器"
...
echo -e " \033[32m 72. \033[0m 安装FSP v1.8.3.5服务器（配套4.36以上服务器）"
...
echo -e " \033[32m 85. \033[0m 修改时间为中国时区"
echo -e ""
...
echo -e " \033[32m 95. \033[0m 修改CES webapp配置信息（适用于4.35版本，需要先安装FSP服务器）"
...
case $N in
  ...
  85) rm -rf /etc/localtime && ln -s /usr/share/zoneinfo/Asia/Shanghai /etc/localtime ;; 
