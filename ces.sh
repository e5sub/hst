...
echo -e " \033[32m 16. \033[0m CES v4.36.3.5单机版"
echo -e " \033[32m 17. \033[0m CES v4.36.3.5集群主服务器"
echo -e " \033[32m 18. \033[0m CES v4.36.3.5集群节点服务器"
echo -e " \033[32m 19. \033[0m CES v4.36.3.5人脸识别服务器"
...
echo -e " \033[32m 79. \033[0m 安装录制服务器v1.0.7.16"
...
echo -e ""
echo -e " \033[32m 92. \033[0m 一键修改H323服务器配置信息（适用于2.3.1.12版本的H323服务器，单机版本选这个）"
echo -e " \033[32m 93. \033[0m 一键修改H323 GM服务器配置信息（适用于2.3.1.12版本，H323集群部署专用）"
